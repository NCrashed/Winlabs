----------------
This version of JsonViewer has been modified from its original by Nick Sabalausky.

The original version can be found at: http://www.codeplex.com/JsonViewer

The main JsonViewer executable is here:
    {Main Goldie Directory}\JsonViewer\Bin\JsonView\JsonView.exe
----------------
