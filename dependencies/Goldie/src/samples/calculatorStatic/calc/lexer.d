...
module samples.calculatorStatic.calc.lexer;
...
//TODO: Make sure col values are correct when there are multi-byte chars
		...
		void addToken(Symbol symbol, string content)
		{
			...
			if(content != "" || symbol.type == SymbolType.EOF)
			{
				...
				case 0:
				_tokens ~=
					new Token_calc!(SymbolType.EOF, "EOF")(
						lang, content,
						filename, line,
				...
				case 1:
				_tokens ~=
					new Token_calc!(SymbolType.Error, "Error")(
						lang, content,
						filename, line,
						srcIndex+srcIndexOffset-cast(int)content.length,
						srcIndex+srcIndexOffset,
				...
				case 2:
				_tokens ~=
					new Token_calc!(SymbolType.Whitespace, "Whitespace")(
						lang, content,
						filename, line,
						srcIndex+srcIndexOffset-cast(int)content.length,
						srcIndex+srcIndexOffset,
				...
				case 3:
				_tokens ~=
					new Token_calc!(SymbolType.Terminal, "-")(
						lang, content,
						filename, line,
						srcIndex+srcIndexOffset-cast(int)content.length,
						srcIndex+srcIndexOffset,
				...
				case 9:
				_tokens ~=
					new Token_calc!(SymbolType.Terminal, "Number")(
						lang, content,
						filename, line,
						srcIndex+srcIndexOffset-cast(int)content.length,
						srcIndex+srcIndexOffset,
